...
For the computer lab in ASTC11: Astrobiolgy, we use this GitHub repo to work on the report. Don't be scared by the look of this programme or by the code you will encounter. We are going through everything together!
...
2. You are now in the folder with the runfile.ipynb. This is the only file you will need to work in.

3. Click on the file `runfile.ipynb` to open it. 
