...
# Program developed by Eric Andersson, 4-5 October 2018.
#
# Last Modified:
#	19/10 - 2018: Added clear function.
#
##############################################################################
...
class Main(object):
	...
	def __init__(self):
		...
		image = Image.open('./src/colMag.jpg') # Load image file
	...
	def save_data(self):
		...
		# Set up file.
		with open(filename, 'w') as f: f.write('#Id\tmag\temag\tcol\tecol\n')
		
		# Write all saved data.
		for index in self.id:
			with open(filename, 'a') as f:
				f.write('%d\t%.2f\t%.2f\t%.2f\t%.2f\n' % galaxy.get_data(index))
		print('Saved data!')
